...
author: " Henry Carvajal (),Julian Delgado () , Mariana Villabona (201816559)"
...
- **mun_area**: Cada fila describe para un municipio en Colombia, identificado por la llave única dpmp.
  Además, presenta información sobre su área, el departamento al que pertenece, el año en que fue creado. 

- **pob_censal**: Cada fila describe para un municipio en Colombia, identificado por la llave única dpmp. 
  Además, presenta información sobre la población de dicho municipio, el departamento al que pertenece y 
  su nombre; así cómo el año al que pertenece la información de población.
